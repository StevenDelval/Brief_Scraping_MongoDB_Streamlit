...
class ImdbCrawlSpiderSpider(CrawlSpider):
    ...
    def parse_item(self, response):
        ...
        item["date"] = response.xpath("/html/body/div[2]/main/div/section[1]/section/div[3]/section/section/div[2]/div[1]/div/ul/li[2]/a/text()").extract()
        ...
        item["public"] = response.xpath("/html/body/div[2]/main/div/section[1]/section/div[3]/section/section/div[2]/div[1]/div/ul/li[3]/a/text()").extract()
